...
// --- Reusable SVG Doodle Components (Same as Before) ---
const DoodleCircle = () => (
  <svg
    id="doodle-circle"
...
// --- Typing Effect Hook (Looping Version) ---
const useTypingEffect = (words, speed = 120, delay = 1000) => {
  ...
  }, [displayed, isDeleting, index, words, speed, delay]);
...
const Hero = () => {
  ...
  const typedText = useTypingEffect(
    ["Web Developer", "UI/UX Designer", "Frontend Developer"],
    120,
    1000
  );
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 items-center gap-16 relative z-10">
        {/* Left Column */}
        <div id="intro-text" className="flex flex-col gap-8 items-start text-white-800">
          <p>hello I'm</p>
          ...
          {/* Typing Effect */}
          <h2 className="text-3xl md:text-4xl font-semibold text-green-400 h-10">
            {typedText}
            <span className="border-r-4 border-green-400 animate-pulse ml-1"></span>
          </h2>
